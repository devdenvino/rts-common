  ...
  return (
    <>
      {layout.startsWith('sidebar') ? (
        ...
        >
          <span>Search...</span>
          <kbd className='pointer-events-none absolute right-1.5 top-1/2 hidden h-5 -translate-y-1/2 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium leading-none opacity-100 sm:flex'>
